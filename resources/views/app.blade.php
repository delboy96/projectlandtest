...
{{--            @csrf--}}
            ...
            <div class="flex flex-col lg:flex-row text-gray-700 font-medium lg:grid grid-cols-3 gap-2">
                ...
                <input id="datepicker" type="text" class=" py-2 px-3 bg-gray-50 text-gray-700 rounded-xl border border-gray-400 focus:outline-none focus:border-teal-600" required>
            </div>
